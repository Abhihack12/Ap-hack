# A tool by nitro from www.abhi.com
...
echo -e "$red                      ⫸$ylo  Abhi pandey$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [hack them with fun]$rset"
echo " "
echo " "
}
baner1(){
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn Ap$red◀$rset"
echo -e "$red                      ⫸$ylo  Abhi pandey$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [hack them with fun]$rset"
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] Tools now"
...
echo -e '\e[92m 
                   ...
                   (_)\_)(_____) (__) (____) '
echo " "
echo -e "\e[91m 😈  Copy this link
and see educational purpose hacking tools
                                👇👇👇

         \e[92mL1NK :- \e[96mhttps://GitHub.com/abhihack12/Ap-hack.git

                                 👆👆👆
Use only for educational purpose not for harming someone 😇✌️.
And  I am is not responsible for any kind of loss 
...
abhi
        ...
        \e[92mL1NK :- \e[96mhttps://bit.ly/3fX8ljZ\e[93m
                    ...
                    👆👆👆
Use only for educational purpose not for harming someone 😇✌️. 
And  I am is not responsible for any kind of 
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mHACKER" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mabhi" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.abhi-hackers.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Abhihack12/Ap-hack.git 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://hackhacktube.com 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
