...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/abhihack12/abhiBomb/archive/dev.zip"
        dir_name = "abhiBomb-dev"
    else:
        zip_url = "https://github.com/Abhihack12/Ap-hack/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/Abhihack12/Ap-hack.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/Abhihack12/Ap-hack.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/Abhihack12/Ap-hack/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/abhihack12/Ap-hack/raw/dev/.notify"
        else:
