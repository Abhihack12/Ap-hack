...
echo " "
echo -e "\e[33m Welcome to [\e[1m\e[32mproject:install Kali linux by abhi\e[21m\e[31m V 2.3\e[33m]"
echo " "
sleep 1
echo -e "\e[1m\e[33m============================================\e[21m"
echo " "
echo -e "\e[33m•••Script by abhi \e[36mThe\e[33mhacker"
echo " "
echo -e "\e[1m\e[33m••••••••••••••••••••••••••••••••••••••••••••\e[21m"
echo " "
sleep 1
echo -e "\e[92minstall requirements of Kali !"
echo " "
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
sleep 2
...
if [ $? -eq 0 ]; then
    echo -e "\e[92m • sys installed ✅"
            echo " "
else
    echo -e "\e[31m • Installing kalisys..."
            echo " "
            sleep 1
